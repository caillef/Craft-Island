...
_G["caillef.craftisland.crafts"] = {
	...
	{
		{ "WOOD_LOG", 2 },
        { "WOODEN_WALL", 3, "WOODEN_STAIRS", 3, "WOODEN_FLOOR", 3, "WOODEN_DOOR", 3, "SMALL_WOODEN_WINDOW", 3, "BIG_WOODEN_WINDOW", 3, "WOODEN_ROOF", 3 },
        CRAFTING_TABLE
    },
    {
		{ "STONE", 2 },
        { "STONEBRICKS_WALL", 3, "STONEBRICKS_STAIRS", 3, "STONEBRICKS_FLOOR", 3, "STONEBRICKS_WINDOW", 3, "STONEBRICKS_DOOR", 3, "STONEBRICKS_ROOF", 3 },
        CRAFTING_TABLE
	}
}
