Assets {
  ...
  BindingSetAsset {
    ...
    Bindings {
      ...
      Action: "Move"
      Description: "Moving the character"
      CoreBehavior {
    ...
    Bindings {
      ...
      Action: "Look"
      Description: "Rotating the camera"
      CoreBehavior {
    ...
    Bindings {
      ...
      Action: "X"
      Description: "Toggle Multi-Level Emotes"
      CoreBehavior {
    ...
    Bindings {
      ...
      Action: "ToggleView"
      Description: "First Person to Third Person View"
      CoreBehavior {
        Value: "mc:ecorebehavior:none"
      }
    }
